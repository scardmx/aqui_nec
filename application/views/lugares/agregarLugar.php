    ...
    <body class="page-sub-page page-submit" id="page-top">
        ...
        <div class="wrapper">
            ...
            <div id="page-content">
                ...
                <div class="container">
                    <header><h1>REGISTRA UN LUGAR</h1></header>

                    <form role="form" id="form-submit"  method="POST" class="form-submit" action="<?php echo base_url(); ?>index.php/lugar/addLugar">
                        <div class="row">
                            <div class="block">
                                <div class="col-md-9 col-sm-9">
                                    <section id="submit-form">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <section id="place-on-map">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="latitude" name="latitude"  style="visibility:hidden">
                                                                </div><!-- /.form-group -->
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="longitude" name="longitude"  style="visibility:hidden">
                                                                </div><!-- /.form-group -->
                                                            </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    <textarea class="form-control"  rows="4" id="referencia" name="referencia" ></textarea>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-default">Agregar Lugar</button>
                                        </div><!-- /.form-group -->
